...
{
    Eigen::Vector3d Pc(parameters[4], parameters[5], parameters[6]);
    Eigen::Quaterniond Qc(parameters[0], parameters[1], parameters[2], parameters[3]);
...
struct cost_function_pnp_quaternion
{
    ...
    bool operator()(const T* const camera_pose, T* residual)const
    {
      ...
      ceres::QuaternionRotatePoint(camera_pose, p_1, p_2);

      p_2[0] = p_2[0] + camera_pose[4];
      p_2[1] = p_2[1] + camera_pose[5];
      p_2[2] = p_2[2] + camera_pose[6];
