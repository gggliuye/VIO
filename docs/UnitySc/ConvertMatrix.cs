...
public class ConvertMatrix
{
    ...
    public ConvertMatrix(float[] cameraPoseInput, bool ifSlam = true)
    {
        //scale = unknownScale;
        ...
        /*
        cameraPoseInput[4 * 0 + 1] = -cameraPoseInput[4 * 0 + 1];
        cameraPoseInput[4 * 1 + 0] = -cameraPoseInput[4 * 1 + 0];
        cameraPoseInput[4 * 1 + 2] = -cameraPoseInput[4 * 1 + 2];
        cameraPoseInput[4 * 2 + 1] = -cameraPoseInput[4 * 2 + 1];
        */
