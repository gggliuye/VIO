...
public:
    ...
    void GetMapPoints(std::vector<Eigen::Vector4d> &vPoses, std::vector<Eigen::Vector3d> &vColors);

    void GetKeyFrames(std::vector<Eigen::Vector3d> &vT, std::vector<Eigen::Vector4d> &vQ);
